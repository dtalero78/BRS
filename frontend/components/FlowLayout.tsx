...
export default function FlowLayout({
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#e6f4fd' }}>
      ...
      <header className={`flex items-center justify-between py-4 bg-white border-b border-gray-100 shadow-sm ${paddingClass}`}>
        ...
        <div className="flex items-center gap-5">
          ...
          {showBack && (
            <Link
              ...
              className="inline-flex items-center text-sm text-gray-400 hover:text-gray-700 transition-colors border-l border-gray-200 pl-5"
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="flex items-center justify-center h-8 w-8 rounded-full transition-opacity hover:opacity-80"
